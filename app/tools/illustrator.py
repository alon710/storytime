    ...
    async def execute(
        ...
        try:
            ...
            if previous_page_images:
                contents.extend(["Previous page illustrations for consistency:"] + previous_page_images)
            ...
            if illustration:
                ...
                self.log_failure("illustration_generation", error="No illustration generated", page_title=story_page.title)
                return None

        except Exception as e:
            self.log_failure("illustration_generation", error=str(e), page_title=story_page.title)
            return None

...
class PDFBuilder:
    ...
    def __init__(self, text_personalizer: TextPersonalizer, color_generator: ColorGenerator):
    ...
    def create_booklet(
        ...
        for i, (page_data, image_path) in enumerate(zip(pages_data, image_paths)):
            ...
            self._create_story_page(
                ...
                character_name, character_age, character_gender, previous_pages, colors
            )
    ...
    def _create_title_page(self, c: canvas.Canvas, width: float, height: float, book_title: str, character_age: int):
    ...
    def _create_story_page(
        ...
        if story_text.strip():
            ...
            self._draw_wrapped_text_in_banner(
                c, personalized_text, text_margin, banner_height - 15, 
                width - (2 * text_margin), 18
            )
        ...
        self._draw_rounded_rect(c, 20, height - title_banner_height - 20, width - 40, title_banner_height, 8)
    ...
    def _draw_gradient_background(self, c: canvas.Canvas, width: float, height: float, color1: str, color2: str):
    ...
    def _draw_image_placeholder(self, c: canvas.Canvas, width: float, height: float, accent_color: str):
